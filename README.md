...
If you are visiting this repository to examine code I presented at the NISO/JATS conference of 2026, please consult the "`presentations`" branch (and its `README` file).  The technical paper is [here](https://scignscape.github.io/PNP/documents/A-perspective-from-compiler-theory.pdf) and slides from that presentation are [here](https://scignscape.github.io/PNP/documents/Nathaniel_Christen_JATS-Con-2026-slides.pdf) Other "work in process" will be deposited in the "`prelim`" branch.
