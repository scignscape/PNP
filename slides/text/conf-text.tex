...
\newcommand{\cframedboxc}[2]{\begin{mdframed}
[linecolor=#1,linewidth=0.4mm,backgroundcolor=white]#2\end{mdframed}}
...
\newcommand{\labelsp}{\hspace*{12pt}}

\newcommand{\dsp}{\hspace*{14pt}}

\newcommand{\vsp}{\vspace*{10pt}}
\newcommand{\vsps}{\vspace*{8pt}}

\definecolor{bkorange}{RGB}{110, 57, 6}

\newcommand{\txtit}[1]{{\fontfamily{bch}\fontseries{m}\selectfont{\itshape#1}}}

\newcommand{\dmark}{\resizebox{13pt}{!}{\MyDiamond}}

\newcommand{\dkitem}{\item[\raisebox{2pt}{\dmark}]}
\newcommand{\dksp}{\hspace*{5pt}}

\newcommand{\rMyOct}{\hspace{4pt} \raisebox{-2pt}{\MyOct}} 

\newcommand{\skl}{\\}


\newcommand{\fbeg}{%
\hspace*{-52pt} \rotatebox{90}{\phantom{XX}%
\textcolor[RGB]{194, 4, 181}{Slides accompanying \textcolor[RGB]{62, 65, 94}{\q{Merging Full-Text Query with Data Sets: 
A perspective from compiler theory}} by Nathaniel Christen}\phantom{X}}\vspace*{-49.1em}%
\hspace*{30pt}}

%62, 65, 94

\let\OldSection\section
\renewcommand{\section}[1]{\OldSection{\raisebox{7pt}{#1}}}

%\newcommand{\rsec}[1]{\raisebox{7pt}{\section{#1}}}


\newenvironment{ftxt}[1][.8\textwidth]{%
\hspace{10pt}\begin{minipage}{#1}\fontsize{20}{32}\selectfont%
}{%
\end{minipage}}


\newenvironment{sftxt}[1][.8\textwidth]{%
\hspace{10pt}\begin{minipage}{#1}\fontsize{19}{27}\selectfont%
}{%
\end{minipage}}



\definecolor{circ}{rgb}{.2,.3,.5}

\usepackage{hyperref}

\newcommand{\pdfsp}[1]{\resizebox{!}{#1}{\textcolor{bkorange}{\texttt{\textbackslash{}pdfsavepos}}}}
...
\part{Research Objects and Text Search}
...
\part{Sentence Objects}

\input{slide14}
\input{slide-ss-sentences}
...
\input{slide-ss-index}

\input{slide-ss-ie}
\input{slide-ss-single}
\input{slide-ss-meta}
\input{slide-ss-pisa}
\input{slide-ss-ling}
...
\part{Scripts and Queries}

\input{slide20}
\input{slide21}
\input{slide22}

\input{slide-ss-parser}

\input{slide23}

\input{slide-ss-chasm}
