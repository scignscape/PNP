...
enum ASG_Proc_Family
{
 ...
 ASG_Graph_Call_Tv, ASG_Graph_Call_TV, ASG_Graph_Call_VT, ASG_Graph_Call_VV,
   ...
   ASG_Graph_Call_CC, ASG_Graph_Call_NC, ASG_Left_Macro, ASG_Right_Macro
};
...
#define ASG_GCALL_NC(name, fam) ASG_Graph_Call_NC, \
 ASG_Proc_Family_<ASG_Graph_Call_NC>::name, ASG_Type_Family::fam
