...
#ifndef ASG_CALL_V_V__H
#define ASG_CALL_V_V__H
...
ASG_PROC_CODES_(ASG_Graph_Call_VV)
 null = 0,
 #include "asg-proc-v-v.h"
...
<ASG_GCALL_VV(Add2, Internal)>
{
  ...
  Chasm_Value_Holder& v2)
 {
  ...
  add2(rh, type_codes, v1.value(), v2.value());
 }
